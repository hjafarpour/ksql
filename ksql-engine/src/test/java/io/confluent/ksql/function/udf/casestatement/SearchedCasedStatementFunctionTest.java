...
public class SearchedCasedStatementFunctionTest {
  ...
  public void shouldWorkForBooleanValues() {
    ...
    // When:
    final Boolean result = SearchedCasedStatementFunction.searchedCasedStatementFunction(
        whenList,
        thenList,
        null
    );
  ...
  public void shouldWorkForIntegerValues() {
    ...
    // When:
    final Integer result = SearchedCasedStatementFunction.searchedCasedStatementFunction(
        whenList,
        thenList,
        null
    );
  ...
  public void shouldWorkForBigIntValues() {
    ...
    // When:
    final Long result = SearchedCasedStatementFunction.searchedCasedStatementFunction(
        whenList,
        thenList,
        null
    );
  ...
  public void shouldWorkForDoubleValues() {
    ...
    // When:
    final Double result = SearchedCasedStatementFunction.searchedCasedStatementFunction(
        whenList,
        thenList,
        null
    );
  ...
  public void shouldWorkForStringValues() {
    ...
    // When:
    final String result = SearchedCasedStatementFunction.searchedCasedStatementFunction(
        whenList,
        thenList,
        null
    );
  ...
  public void shouldWorkForArrayValues() {
    ...
    // When:
    final List<String> result = SearchedCasedStatementFunction.searchedCasedStatementFunction(
        whenList,
        thenList,
        null
    );
  ...
  public void shouldFailIfWhenAndThenDontHaveSameSize() {
    ...
    expectedException.expectMessage("Invalid arguments. When list and Then list should have the same size. When list size is 4, thenList size is 3");
